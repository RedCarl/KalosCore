...
public class QuestGUI extends InventoryGUI {
    ...
    public QuestGUI(Player player, QuestType questType) {//为指定玩家创建箱子页面
        ...
        //每日任务
        ItemStack DayMission = SkullAPI.getSkullItem("f8e5a3a85f82f772b10ddda1e216576ff1b9a98344e0753b68dde06f7f2157f4",ColorParser.parse("&a每日任务"),
        ...
        //每周任务
        ItemStack WeekMission = SkullAPI.getSkullItem("fcae5d0379fe73b94042178d87d98298d3cde7da126b18dcce4a3a6c663fafb7",ColorParser.parse("&b每周任务"),
        ...
        //挑战任务
        ItemStack ChallengeMission = SkullAPI.getSkullItem("22938b36057d883868638fe703473c3ee70ba2798aba54514cb2b2f912822ed1",ColorParser.parse("&c挑战任务"),
        ...
        //成就任务
        ItemStack AchievementMission = SkullAPI.getSkullItem("4a3890aa8c76f177cbae7dc0966149a2e0fb1c1efeb283deb7deaa09fd0fb6",ColorParser.parse("&6成就任务"),
                ColorParser.parse("&7任务时间: &f不限制,一次性任务"),
                ColorParser.parse("&r"),
