        ...
        if (commandSender.hasPermission("kim.admin")){
            if (args.length == 1 && commandSender instanceof Player && ((Player)commandSender).getInventory().getItemInMainHand()!=null) {
                if (args[0].equals("add")) {
                    Main.getInstance().getPokemonBanDataSQLReader().addDrops(((Player)commandSender).getInventory().getItemInMainHand().getType().name());
                    commandSender.sendMessage("封禁了宝可梦掉落物 " + ((Player)commandSender).getInventory().getItemInMainHand().getType().name());
                }

                if (args[0].equals("remove")) {
                    Main.getInstance().getPokemonBanDataSQLReader().removeDrops(((Player)commandSender).getInventory().getItemInMainHand().getType().name());
            ...
            if (args.length == 2) {
                if (args[0].equals("add")) {
                    Main.getInstance().getPokemonBanDataSQLReader().addDrops(args[1]);
                    commandSender.sendMessage("封禁了宝可梦掉落物 " + args[1]);
                }

                if (args[0].equals("remove")) {
                    Main.getInstance().getPokemonBanDataSQLReader().removeDrops(args[1]);
