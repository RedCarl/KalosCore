package kim.pokemon.manager.questmanager.quest.list.achievement;

import kim.pokemon.Main;
import kim.pokemon.manager.questmanager.manager.QuestManager;
import kim.pokemon.manager.questmanager.quest.QuestState;
import kim.pokemon.manager.questmanager.quest.quest.AchievementQuest;
import kim.pokemon.manager.questmanager.quest.requirement.CatchRequirement;
import kim.pokemon.manager.questmanager.quest.requirement.WinRequirement;
...
public class Achievement {
    ...
    public void quest0(){
        ...
        achievement_b.setReward((player) -> {
            ...
            Main.econ.depositPlayer(player,1390);
            Main.ppAPI.giveAsync(player.getUniqueId(),2);
            player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP,1,1);
        });
        ...
        achievement_c.setReward((player) -> {
            ...
            Main.econ.depositPlayer(player,4390);
        ...
        achievement_d.setReward((player) -> {
            ...
            Main.econ.depositPlayer(player,8390);
